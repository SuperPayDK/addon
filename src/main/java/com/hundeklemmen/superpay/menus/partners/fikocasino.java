...
public class fikocasino extends Screen {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(matrixStack, this.font, "§aSuperPay§b + §aFikoCasino", this.width / 2, 20, 2);
        drawCenteredString(matrixStack, this.font, "§aØnsker du at godkende følgende transaktion? ", this.width / 2, 50, 1);
        //Pakke
        LabyMod.getInstance().getDrawUtils().drawRightString(matrixStack, "§aCoins:", this.width / 2 - 25, 105, 1);
        drawString(matrixStack, this.font, "§b" + anmodning.getPakke(), this.width / 2 + 25, 105, 1);
        //Pris
        LabyMod.getInstance().getDrawUtils().drawRightString(matrixStack, "§aPris:", this.width / 2 - 25, 130, 1);
        drawString(matrixStack, this.font, "§b" + Addon.decimalFormat.format(anmodning.getAmount()) + " Emeralder", this.width / 2 + 25, 130, 1);
